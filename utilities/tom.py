def capacity_allocation(config, esketamine_fraction=0.2):
    ...
    capacities = {}
    capacities["ad"] = config["capacities"]["antidepressant"]
    capacities["ap"] = config["capacities"]["antipsychotic"]
    capacities["ad_ap"] = config["capacities"]["antidepressant_antipsychotic"]
    capacities["esketamine"] = config["capacities"]["esketamine"]
    capacities["ect"] = config["capacities"]["ect"]
